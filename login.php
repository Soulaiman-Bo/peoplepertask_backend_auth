<?php require_once "scripts/login_script.php" ?>
-->
<!DOCTYPE html>
<html lang="en">
...
<body class="dark:bg-gray-900 ">
    ...
    <section class="flex justify-center m-auto items-center max-w-screen-xl py-32 dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-10 w-[70%] bg-white border rounded-3xl dark: dark:bg-gray-700  ">
            ...
            <form action="login.php" method="POST" class="space-y-8 " id="form">
                <div>
                ...
                <div class="flex justify-center">
                    <Button type="submit" class="py-3 text-sm font-medium text-center text-white rounded-3xl bg-orange-600 w-60 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 ">Log In</Button>
                </div>
