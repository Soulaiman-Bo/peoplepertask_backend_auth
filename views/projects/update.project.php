...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        updatePR($ID, $title, $description, $tags, $minprice, $maxprice, $hours, $duration, $experince, $country, $category);
...
<body class="dark:bg-gray-900">
    ...
    <main class="mt-14 p-12 ml-0 smXl:ml-64 dark:border-gray-700">
        ...
        <div class="h-fit ">
            <form action="?action=updateproject&project=<?php echo $ID ?>" method="POST" class="max-w-xl mx-auto bg-white border p-8 rounded-2xl ">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="tags" value="<?php echo $tags; ?>" id="tags" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="PHP, JAVASCRIPT, CSS, HTML" required>
