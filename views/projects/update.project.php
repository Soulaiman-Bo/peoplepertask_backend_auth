...
<body class="dark:bg-gray-900">
    ...
    <main class="mt-14 p-12 ml-0 smXl:ml-64 dark:border-gray-700">
        ...
        <div class="h-full">
            <form action="?action=updateproject&project=<?php echo $ID ?>" method="POST" class="w-3/4 mx-auto bg-white border p-8 rounded-2xl border-b dark:bg-gray-800 dark:border-gray-700">
