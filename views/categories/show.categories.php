<?php require_once "scripts/showcategories_script.php" ?>
-->
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="mt-14 p-12 ml-0 smXl:ml-64 dark:border-gray-700">
        <div class="flex flex-col justify-center items-center">
            ...
            <div class="relative overflow-x-auto">
                <!-- Modal toggle -->
                <a href="?action=createcategory" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="block mb-7 font-inter text-white w-fit bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                    + Add Category
                </a>
