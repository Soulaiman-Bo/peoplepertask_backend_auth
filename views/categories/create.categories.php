<?php require_once "scripts/createcategories_script.php" ?>
-->
<!DOCTYPE html>
<html lang="en">
...
<body class="dark:bg-gray-900">
    ...
    <main class="mt-14 p-12 ml-0 smXl:ml-64 dark:border-gray-700">
        ...
        <div class="h-fit ">
            <form action="?action=createcategory" method="POST" class="max-w-xl mx-auto bg-white border p-8 rounded-2xl ">
