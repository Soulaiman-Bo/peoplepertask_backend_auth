  ...
  <section class="hero-section">
    <div class="grid max-w-screen-xl mt-10 px-4 py-8  mx-auto lg:gap-0 xl:gap-0 lg:py-16 lg:grid-cols-12">
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img src="public/images/hero.png" alt="Freelance">
      </div>
    </div>
  </section>
      ...
      <div class="grid gap-6 lg:gap-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 items-center">
          ...
          <div class="shadow-md hidden sm:block">
            <a href="marketplace.php" class="block w-full h-50 relative rounded-2xl overflow-hidden">
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <span class="text-white text-xl font-bold tracking-wider"><?= $card['category_name'] ?></span>
              </div>
            </a>
          </div>
        <?php endforeach; ?>
        ...
        <div class="shadow-md">
          <a href="../src/marketplace.html" class="block w-full h-50 relative rounded-2xl overflow-hidden">
            <img class="w-full h-full" src="public/images/category1.png" alt="Graphic Design">
            <div class="absolute inset-0 bg-black bg-opacity-50"></div>
            <div class="absolute inset-0 flex items-center justify-center">
        ...
        <div class="shadow-md hidden sm:block">
          <a href="../src/marketplace.html" class="block w-full h-50 relative rounded-2xl overflow-hidden">
            <img class="w-full h-full" src="public/images/category3.png" alt="Illustration">
            <div class="absolute inset-0 bg-black bg-opacity-50"></div>
            <div class="absolute inset-0 flex items-center justify-center">
        ...
        <div class="shadow-md">
          <a href="../src/marketplace.html" class="block w-full h-50 relative rounded-2xl overflow-hidden">
            <img class="w-full h-full " src="public/images/category4.png" alt="Video Editing">
            <div class="absolute inset-0 bg-black bg-opacity-50"></div>
            <div class="absolute inset-0 flex items-center justify-center">
    ...
    <div class=" flex flex-col items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <div class="grid gap-6 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-center">
        <!-- <div class="text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 py-12 px-12 w-64 rounded-xl shadow-md">
          <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="public/images/freelancer2.jpg" alt="Khalid Oukha">
        ...
        <div class="text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 py-12 px-12 w-64 rounded-xl shadow-md">
          <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="public/images/freelancer3.jpg" alt="Yassine Louissi">
          <h3 class="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
        ...
        <div class="text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 py-12 px-12 w-64 rounded-xl shadow-md">
          <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="public/images/freelancer1.jpg" alt="Abdeljabbar Ait">
          <h3 class="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
        ...
        <?php foreach ($users as $user) : ?>
          <div class="text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 py-12 px-12 w-64 rounded-xl shadow-md">
            <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="public/images/freelancer2.jpg" alt="Khalid Oukha">
            <h3 class="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="../src/freelancers.html"><?= $user['firstname'] ?> <?= $user['lastname'] ?></a>
            </h3>
            <p>Graphic Designer</p>
          </div>
        <?php endforeach; ?>
    ...
    <div class=" flex flex-col justify-evenly sm:flex-row lg:flex-row items-center py-8 px-8 mx-auto max-w-screen-xl lg:px-6 lg:py-16 ">
      ...
      <div class="-mx-6 lg:col-span-2 lg:mx-0 self-center justify-start overflow-hidden mt-4 shadow-md" id="client">
        <div id="clients_slider" class="w-[410px] flex gap-4 px-2 duration-200">
          ...
          <?php
          require_once 'model/testimonial_model.php';
          $alltestimonial = getAllTes();
          ?>

          <?php foreach ($alltestimonial as $testimonial) : ?>
            <div class="client">
              <div class="flex h-fit flex-col justify-between bg-white dark:bg-gray-800 p-6  rounded-2xl mt-3 shadow-sm w-96  sm:p-8 lg:p-12">
                <div>
                  <div class="flex items-center ">
                    <img src="public/images/client2.jpg" alt="Aymane Benhima" class="mb-4 rounded-full w-11 h-11">
                    <div class="flex flex-col mb-4 ml-8">
                      <h3 class="dark:text-white"><?= $testimonial['firstname'] ?> <?= $testimonial['lastname'] ?></h3>
    ...
    <div class="mx-auto max-w-screen-xl ">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          ...
          <a href="www.github.com/zaiidmo/PeoplePerTasks" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
